  ...
  return (
    <header className={`text-gray-400 bg-gray-900 ${scrollActive} body-font`}>
      <div id="nav" className="container mx-auto justify-between flex flex-wrap p-5 flex-row md:flex-row">
        <a className="flex title-font font-medium items-center text-white mb-4 md:mb-0 md:pr-0">
        ...
        <nav className={`px-8 py-6 flex flex-wrap text-base justify-center flex-col md:right-0 gap-8 items-start bg-gray-800
          ...
          <a href="#profile" className="mr-5 hover:text-white">Profile</a>
          <a href="#ourTeam" className="mr-5 hover:text-white">Our Team</a>
          <a href="#contact" className="mr-5 hover:text-white">Contact</a>
        </nav>
        <div className="inline-flex md:right-0 hover:bg-gray-700 rounded text-base mt-[15px] mb-[15px]">
          <button className="inline-flex items-center bg-gray-800 border-0 py-1 px-5 focus:outline-none ">Button
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-1" viewBox="0 0 24 24">
              <path d="M5 12h14M12 5l7 7-7 7"></path>
            </svg>
          </button>
          <i className="ri-menu-fill text-3xl md:hidden block items-center mt-auto mb-auto pl-3" onClick={handleClick}></i>
        </div>
      </div>
    </header>
  )
